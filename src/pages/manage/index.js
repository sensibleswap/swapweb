  ...
  renderNoData(title, text, url) {
    return (
      <div className={styles.no_data}>
        ...
        <Link to={url} className={styles.no_data_link}>
          {text}
        </Link>
      </div>
    );
      ...
      <div className={styles.content}>
        ...
        <div className={styles.item}>
          <div className={styles.title}>
            {_('your_total_liq')} <span>({_('include_fees')})</span>
          </div>
          <div className={styles.value}>$23,838.06</div>
        </div>
        <div className={styles.item}>
          <div className={styles.title}>
            {_('fees_earned')} <span>({_('cumulative')})</span>
          </div>
          <div className={styles.value} style={{ color: '#229278' }}>
            $2,232.89
          </div>
        </div>
