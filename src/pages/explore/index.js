      ...
      <div className={styles.list_wrap}>
        <div className={styles.list}>
          ...
          <div className={styles.list_item} onClick={() => this.gotoPage()}>
            <div className={styles.col_1}>
              <div className={styles.icon}>
                <CustomIcon type="iconlogo-bitcoin" style={{ fontSize: 40 }} />
              </div>
            ...
            <div className={jc(styles.col_3, styles.red)}>
              <CaretUpOutlined /> 23.32%
            </div>
          ...
          <div className={styles.list_item} onClick={() => this.gotoPage()}>
            <div className={styles.col_1}>
              <div className={styles.icon}>
                <CustomIcon type="iconlogo-vusd" style={{ fontSize: 40 }} />
              </div>
              <div className={styles.item_title}>
            ...
            <div className={jc(styles.col_3, styles.green)}>
              <CaretDownOutlined /> 0.16%
            </div>
